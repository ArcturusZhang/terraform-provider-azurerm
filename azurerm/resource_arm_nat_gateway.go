...
func resourceArmNatGatewayDelete(d *schema.ResourceData, meta interface{}) error {
	...
	return waitForNatGatewayToBeDeleted(ctx, client, resourceGroup, name)
}

func waitForNatGatewayToBeDeleted(ctx context.Context, client *network.NatGatewaysClient, resourceGroup, name string) error {
