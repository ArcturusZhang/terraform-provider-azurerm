...
func TestAccLinuxVirtualMachine_otherForceDeletionEnabled(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_linux_virtual_machine", "test")
	r := LinuxVirtualMachineResource{}
...
func TestAccLinuxVirtualMachine_otherForceDeletionDisabled(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurerm_linux_virtual_machine", "test")
	r := LinuxVirtualMachineResource{}
...
func (LinuxVirtualMachineResource) otherForceDeletion(data acceptance.TestData, forceDeletion bool) string {
	return fmt.Sprintf(`
locals {
  first_public_key = "ssh-rsa  you@me.com"
}
...
`, forceDeletion, data.RandomInteger, data.Locations.Primary, data.RandomInteger, data.RandomInteger, data.RandomInteger)
}
